...
- IBM Db2 11.5.6.0 container from [Docker Hub](https://hub.docker.com/r/ibmcom/db2) or Postgresql
...
The default password expiry period for Db2 database user ```db2inst1``` is set to 90 days. If you intend to keep the demo environment running for more than 3 months, you need to modify the password expiry period using these commands:<br>
