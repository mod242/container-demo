...
The global password parameter used for all LDAP and database user accounts only supports lowercase and uppercase alphabetic characters and numbers. No symbols are allowed.
